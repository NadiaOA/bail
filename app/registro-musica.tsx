...
const s = StyleSheet.create({
  ...
  optionSelected: { borderColor: "#4A6C9B", backgroundColor: "#E8EFF5" },
  emoji: { fontSize: 30 },
  nombre: { fontSize: 26, fontWeight: "700", color: "#2A1A1A", flex: 1 },
  nombreSelected: { color: "#4A6C9B" },
  check: { fontSize: 24, color: "#4A6C9B", fontWeight: "800" },
  hint: {
    fontSize: 18,
    color: "#5C6B7F",
    textAlign: "center",
  ...
  btnText: { fontSize: 26, fontWeight: "800", color: "white" },
});

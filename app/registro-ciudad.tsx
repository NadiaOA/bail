...
const s = StyleSheet.create({
  ...
  title: { fontSize: 30, color: "#F5EDE0", lineHeight: 38 },
  ...
  fieldValue: { fontSize: 22, color: "#2A1A1A" },
  ...
  dropText: { fontSize: 18, color: "#2A1A1A", fontWeight: "500" },
  ...
  btnText: { fontSize: 22, fontWeight: "800", color: "#F5EDE0" },
});
